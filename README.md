...
Installs Nginx on Debian/Ubuntu Linux. Adapted from geerlinguy.nginx

This role installs and configures the latest version of Nginx. You will likely need to do extra setup work after this role has installed Nginx, like adding your own [virtualhost].conf file inside `/etc/nginx/conf.d/`, describing the location and options to use for your particular website.
...
Raging Bal - reference Geerlinguy.nginx